...
public class DatabaseBroker {
    ...
    public DatabaseBroker() {
        try {
            ...
            if (connection != null && connection.isValid(2)) {
                ...
                System.out.println("Failed to establish a valid database connection.");
            }
        } catch (Exception ex) {
    ...
    public List<OpstiDomenskiObjekat> select(OpstiDomenskiObjekat odo) throws SQLException {
    ...
    public OpstiDomenskiObjekat selectOne(OpstiDomenskiObjekat odo) throws SQLException {
        String upit = "SELECT * FROM " + odo.getTableName() + " " + odo.alijas() + " " + odo.join() + odo.getWhereCondition();
        System.out.println(upit);
        Statement s = connection.createStatement();
        ResultSet rs = s.executeQuery(upit);
